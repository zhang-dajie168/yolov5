...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default=ROOT / '/home/ymt/yolov5-7.0/runs/train-seg/exp43/weights/best.pt',
                        help='model path(s)')
    parser.add_argument('--source', type=str,
                        default=ROOT / '/home/ymt/data/11.转转手机外观检测/project/前后摄像头/img-copy',help='file/dir/URL/glob/screen/0(webcam)')
